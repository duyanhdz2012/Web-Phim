      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white">Bố Phim</h3>
                <p className="text-gray-400 text-sm">Phim như con cac</p>
              </div>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              Nền tảng xem phim trực tuyến hàng đầu Việt Nam. 
              Khám phá kho tàng phim đa dạng với chất lượng cao.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Phim đề cử</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Thể loại</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Quốc gia</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Hỏi - Đáp</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            ...
            <span className="text-red-400 ml-2">🇻🇳 Tự hào là sản phẩm Việt Nam</span>
          </p>
        </div>
      </div>
    </footer>
