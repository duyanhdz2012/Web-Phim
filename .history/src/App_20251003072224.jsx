...
import AdvancedMovieFilter from "./components/AdvancedMovieFilter";
...
function App() {
  ...
  const handleSearch = async (keyword) => {
    ...
    try {
      const data = await movieApi.searchMovies(keyword, 1, filters.category, filters.country, filters.year, 20);
    ...
    setFilters(prev => ({ ...prev, year }));
         ...
         const loadMovies = async (page = 1) => {
           ...
           try {
             let data;
             if (isSearching) {
               data = await movieApi.searchMovies(
             ...
             // Set suggested movies for header background
             setSuggestedMovies(movieData.slice(0, 4));
  ...
  }, [filters.category, filters.country, filters.year, filters.type]);
