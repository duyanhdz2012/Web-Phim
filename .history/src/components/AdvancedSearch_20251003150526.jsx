      ...
      <div className="container mx-auto px-6 py-8">
        {loading ? (
          ...
          <>
            ...
            {/* Background Search Complete Notification */}
            {fullResults && !backgroundSearch.isRunning && (
              <div className="bg-green-900/50 border border-green-500/30 rounded-lg p-4 mb-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <span className="text-green-400">✅</span>
                    <span className="text-green-300 font-medium">Tìm kiếm hoàn tất!</span>
                  </div>
                  <span className="text-green-400 text-sm">
                    {fullResults.totalItems} phim tìm thấy
                  </span>
                </div>
                <div className="text-green-400 text-sm mt-1">
                  Đã tìm kiếm trong toàn bộ database. Bạn có thể xem tất cả {fullResults.totalPages} trang kết quả.
                </div>
              </div>
            )}
