          ...
          <div className="flex items-center space-x-8">
            ...
            <Link to="/" className="flex items-center space-x-2 group">
              <div className="relative">
                {/* Logo của bạn - thay đổi đường dẫn này */}
                <img 
                  src="/src/assets/logos/my-logo.png" 
                  alt="Logo" 
                  className="w-8 h-8 rounded-lg shadow-lg group-hover:shadow-yellow-400/50 transition-all duration-300 object-cover"
                  onError={(e) => {
                ...
                />
                {/* Fallback logo cũ nếu logo mới không tải được */}
                <div className="w-8 h-8 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-yellow-400/50 transition-all duration-300" style={{display: 'none'}}>
