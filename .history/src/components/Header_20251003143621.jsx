...
const Header = () => {
  ...
  const shouldShowShadow = isScrolled || !isHomePage;

  return (
    <div className={`sticky top-0 z-[100] bg-gray-900/95 backdrop-blur-md border-b border-gray-700/50 transition-shadow duration-300 ${
      ...
      <div className="px-6 py-4">
          ...
          <div className="flex items-center space-x-8">
            ...
            <Link to="/" className="flex items-center space-x-3 group">
              <div className="relative">
                <div className="w-10 h-10 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-yellow-400/50 transition-all duration-300">
        ...
        <input
          type="text"
                ...
                className="w-full px-4 py-3 pl-12 pr-4 bg-gray-800/50 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition-all duration-300 backdrop-blur-sm"
          value={search}
          onChange={(e) => setSearch(e.target.value)}
                onKeyPress={handleKeyPress}
              />
              <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-yellow-400 transition-colors duration-300">
