      ...
      {logoImage && !imageError ? (
        ...
        <div className="relative">
          <img 
            src={logoImage} 
            alt="Logo" 
            className="max-h-16 w-auto rounded-lg shadow-lg group-hover:shadow-cyan-400/50 transition-all duration-300 border-2 border-transparent group-hover:border-cyan-300/30"
