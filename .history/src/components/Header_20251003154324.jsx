          ...
          <div className="flex items-center space-x-8">
            ...
            <Link to="/" className="flex items-center group">
              <div className="relative">
                {/* Logo của bạn - kích thước lớn hơn */}
                <img 
                  src="/src/assets/logos/logo.jpg" 
                  alt="Logo" 
                  className="w-16 h-16 rounded-lg shadow-lg group-hover:shadow-yellow-400/50 transition-all duration-300 object-cover"
                  onError={(e) => {
                ...
                <div className="w-16 h-16 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-yellow-400/50 transition-all duration-300" style={{display: 'none'}}>
