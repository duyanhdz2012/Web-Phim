...
const Header = () => {
  ...
  const handleAuthSubmit = (e) => {
    ...
    console.log('Auth form submitted:', { isLogin, ...authForm });
              ...
              <form onSubmit={handleAuthSubmit} className="space-y-4">
                ...
                <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-white text-sm">Thành công!</span>
                    <div className="flex-1"></div>
                    <div className="text-right">
                      <div className="text-gray-300 text-xs font-semibold">CLOUDFLARE</div>
                      <div className="flex space-x-3 text-xs text-gray-400">
                        <button className="hover:text-white transition-colors duration-200">Quyền riêng tư</button>
                        <button className="hover:text-white transition-colors duration-200">Điều khoản</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-yellow-500 hover:bg-yellow-600 text-white font-medium py-3 rounded-lg transition-colors duration-200"
                >
