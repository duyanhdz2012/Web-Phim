...
export const movieApi = {
  ...
  searchMovies: async (keyword, page = 1, category = '', country = '', year = '', limit = 20) => {
    try {
      ...
      // Build search URL with parameters according to KKPhim API documentation
      let searchUrl = `${BASE_URL}/v1/api/tim-kiem?keyword=${encodeURIComponent(keyword)}&page=${page}&sort_field=_id&sort_type=desc&sort_lang=long-tieng&limit=${limit}`;
  ...
  getMoviesByCategoryNew: async (category, options = {}) => {
    try {
      ...
      const response = await fetch(`${BASE_URL}/v1/api/danh-sach/${encodeURIComponent(category)}?page=${page}&sort_field=${sort_field}&sort_type=${sort_type}&sort_lang=${sort_lang}&limit=${limit}`, {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
  ...
  getMoviesByCountry: async (country, options = {}) => {
    try {
      ...
      const response = await fetch(`${BASE_URL}/v1/api/quoc-gia/${encodeURIComponent(country)}?page=${page}&sort_field=${sort_field}&sort_type=${sort_type}&sort_lang=${sort_lang}&limit=${limit}`, {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
  ...
  getMoviesByYearNew: async (year, options = {}) => {
    try {
      ...
      const response = await fetch(`${BASE_URL}/v1/api/nam/${year}?page=${page}&sort_field=${sort_field}&sort_type=${sort_type}&sort_lang=${sort_lang}&limit=${limit}`, {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
  ...
  getMoviesByType: async (type, options = {}) => {
    try {
      ...
      const response = await fetch(`${BASE_URL}/v1/api/danh-sach/${encodeURIComponent(type)}?page=${page}&sort_field=${sort_field}&sort_type=${sort_type}&sort_lang=${sort_lang}&limit=${limit}`, {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
  ...
  getCategories: async () => {
    try {
      console.log('Fetching categories from KKPhim API');
      ...
      const data = await response.json();
      console.log('KKPhim categories API response:', data);
      return data;
    } catch (error) {
  ...
  getCountries: async () => {
    try {
      console.log('Fetching countries from KKPhim API');
      ...
      const data = await response.json();
      console.log('KKPhim countries API response:', data);
      return data;
    } catch (error) {
