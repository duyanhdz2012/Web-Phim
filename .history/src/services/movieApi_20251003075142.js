...
export const movieApi = {
  ...
  getMoviesList: async (typeList, options = {}) => {
    try {
      ...
      let url = `${BASE_URL}/danh-sach/${typeList}?page=${page}&limit=${limit}`;
  ...
  searchMovies: async (keyword, options = {}) => {
    try {
      ...
      let url = `${BASE_URL}/tim-kiem?keyword=${encodeURIComponent(keyword)}&page=${page}&limit=${limit}`;
      
      if (category) url += `&category=${encodeURIComponent(category)}`;
      if (country) url += `&country=${encodeURIComponent(country)}`;
      if (year) url += `&year=${year}`;
      
      console.log('Searching movies from NguonC API:', url);
      const response = await fetch(url, {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
      ...
      const data = await response.json();
      console.log('NguonC Search API response:', data);
      return data;
    } catch (error) {
  ...
  // Tìm kiếm phim theo thể loại (new version)
  getMoviesByCategoryNew: async (category, options = {}) => {
    try {
      ...
      let url = `${BASE_URL}/the-loai/${encodeURIComponent(category)}?page=${page}&limit=${limit}`;
      
      console.log(`Fetching movies by category ${category} from NguonC API:`, url);
      const response = await fetch(url, {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
      ...
      const data = await response.json();
      console.log(`NguonC Category ${category} API response:`, data);
      return data;
    } catch (error) {
  ...
  getMoviesByCountry: async (country, options = {}) => {
    try {
      ...
      let url = `${BASE_URL}/quoc-gia/${encodeURIComponent(country)}?page=${page}&limit=${limit}`;
      
      console.log(`Fetching movies by country ${country} from NguonC API:`, url);
      const response = await fetch(url, {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
      ...
      const data = await response.json();
      console.log(`NguonC Country ${country} API response:`, data);
      return data;
    } catch (error) {
  ...
  // Tìm kiếm phim theo năm (new version)
  getMoviesByYearNew: async (year, options = {}) => {
    try {
      ...
      let url = `${BASE_URL}/nam/${year}?page=${page}&limit=${limit}`;
      
      console.log(`Fetching movies by year ${year} from NguonC API:`, url);
      const response = await fetch(url, {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
      ...
      const data = await response.json();
      console.log(`NguonC Year ${year} API response:`, data);
      return data;
    } catch (error) {
